...
export const PROMPT_VARIABLES: PromptVariable[] = [
  ...
  { id: 'itunes_rating_count_bracket', group: 'podcast', column: 'itunes_rating_count_bracket', type: 'text', label: "Apple ratings bracket" },
  { id: 'spotify_rating_count_bracket', group: 'podcast', column: 'spotify_rating_count_bracket', type: 'text', label: "Spotify ratings bracket" },
  { id: 'brand_safety_framework', group: 'podcast', column: 'brand_safety_framework', type: 'text', label: "Brand safety framework" },
  { id: 'podcast_itunes_id', group: 'podcast', column: 'podcast_itunes_id', type: 'text', label: "Apple Podcasts ID" },
  { id: 'podcast_spotify_id', group: 'podcast', column: 'podcast_spotify_id', type: 'text', label: "Spotify ID" },
  { id: 'podcast_guid', group: 'podcast', column: 'podcast_guid', type: 'text', label: "Podcast GUID" },
